...
select customerID,isnull(email ,'EMAIL NA'),isnull(phonenumber,'phone NA')
from customers
-- With this query, if the email or phone number is NULL, the specified text will be shown instead.
